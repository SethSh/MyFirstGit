...
{
    internal class PolicyProfileColumnInserter : BaseColumnInserter
    {
        ...
        public override bool Validate(ISegmentExcelMatrix excelMatrix, Range range)
        {
            ...
            {
                var message = $"In order to insert columns, the selected {PionlearClient.BexConstants.PolicyProfileName.ToLower()} can't be Flat";
